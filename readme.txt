...
The shortcode is available once the plugin has been activated. The shortcode will display the latest custom post from the ‘portfolio’ custom post type and is meant to highlight the latest and greatest content. A thumbnail, post title, and read more link will be available through the use of the shortcode. This shortcode can be used by adding ‘[btn-breakthenews]’ anywhere on your post or page.
